...
Last updated: 2026-08-28 · model **v0.12.0** · after **WP1, WP2, WP5**.
...
renewal loop (WP5). **Still empty:** delegated authority (WP6). **Still thin (assets,
customer/conduct):** WP3/WP4 next.
